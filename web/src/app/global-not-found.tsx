...
export const metadata: Metadata = {
  ...
  description:
    'Lo sentimos, la página que buscas no existe. ¡Pero nuestras mascotas están aquí para ayudarte!',
}
    ...
    <html lang="es" className={`${fredoka.variable} ${latto.variable}`}>
      <body className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 min-h-screen">
          ...
          <div className="max-w-2xl mx-auto text-center space-y-6 sm:space-y-8">
            ...
            <div className="relative">
              <div className="w-48 h-48 sm:w-64 sm:h-64 mx-auto mb-6 relative">
                ...
                {/* Cat searching */}
                <div
                  className="absolute top-1/2 right-1/4 text-3xl sm:text-5xl animate-bounce"
                ...
                <div
                  className="absolute bottom-1/3 left-1/3 text-lg sm:text-2xl opacity-60 animate-pulse"
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <p className="text-base sm:text-lg font-latto text-gray-600 dark:text-gray-300 max-w-md mx-auto leading-relaxed">
                Parece que nuestras mascotas no pudieron encontrar esta página. ¡Pero no te
                preocupes, te ayudamos a encontrar lo que buscas!
              </p>
            </div>
            ...
            <div className="mt-8 p-4 sm:p-6 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 shadow-lg">
              ...
              <p className="text-sm sm:text-base font-latto text-gray-700 dark:text-gray-300">
                Los perros pueden oler hasta 100,000 veces mejor que los humanos, ¡pero aún no
                pueden encontrar páginas web perdidas! 🐕‍🦺
              </p>
            </div>

            {/* Contact section */}
            <div className="text-center pt-4">
              <p className="text-sm font-latto text-gray-500 dark:text-gray-400">
                ¿Necesitas ayuda?
                <Link
                  href="/contact"
        ...
        <div className="fixed inset-0 pointer-events-none overflow-hidden">
          ...
          <div
            className="absolute top-20 right-20 text-xl opacity-30 animate-float"
            style={{ animationDelay: '2s' }}
          >
            🦴
          </div>
          <div
            className="absolute bottom-20 left-20 text-xl opacity-30 animate-float"
            style={{ animationDelay: '4s' }}
          >
            🐾
          </div>
          <div
            className="absolute bottom-10 right-10 text-2xl opacity-30 animate-float"
