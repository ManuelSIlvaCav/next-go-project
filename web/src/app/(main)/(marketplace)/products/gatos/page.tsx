...
export default function GatosPage() {
  const catCategories = [
    { name: 'Alimento Seco', count: 98, href: '/products/gatos/secos' },
    { name: 'Alimento Húmedo', count: 156, href: '/products/gatos/humedos' },
    { name: 'Snacks y Premios', count: 187, href: '/products/gatos/snacks' },
    { name: 'Arena Sanitaria', count: 123, href: '/products/gatos/arena' },
    { name: 'Gatitos', count: 67, href: '/products/gatos/gatitos' },
    { name: 'Senior', count: 34, href: '/products/gatos/senior' },
  ]
      ...
      <div className="bg-white dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-700">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-900 font-medium dark:text-zinc-100">Gatos</span>
          </nav>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-zinc-100 mb-6">
            Productos Destacados para Gatos
          </h2>
